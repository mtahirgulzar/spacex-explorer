    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <Button 
          ...
          className="mb-8 gap-2 cursor-pointer bg-white border-gray-300 text-gray-700 hover:bg-gray-50"
          variant="outline"
          size="sm"
        >
          <ArrowLeft className="h-4 w-4" />
        ...
        <div className="space-y-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <Typography variant="h1" className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                {launch.name}
              </Typography>
              <div className="mt-2">
            ...
            <div className="flex items-center gap-3">
              ...
              {launch.links?.article && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                >
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="space-y-2 text-sm">
                      {rocket.engines.propellant_1 && (
                        <div>Primary: {rocket.engines.propellant_1}</div>
                      )}
                      {rocket.engines.propellant_2 && (
                        <div>Secondary: {rocket.engines.propellant_2}</div>
                      )}
                      <div>Type: {rocket.engines.type}</div>
